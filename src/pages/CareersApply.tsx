          ...
          {sent ? (
            ...
            <form onSubmit={onSubmit} className="apply-card card" style={{ marginTop: 28 }}>
              ...
              <div className="apply-grid">
                ...
                <SelectField id="ap-cursal" label={t.appCurrentSalary} value={curSalary} onChange={setCurSalary} options={SALARY_BANDS} placeholder={t.appSelect} />
                ...
                <SelectField id="ap-notice" label={t.appNotice} value={notice} onChange={setNotice} options={NOTICE_PERIODS} placeholder={t.appSelect} />
